...
import RecentPost1 from "@/app/assets/content-img/recent_post1.jpg";
import RecentPost2 from "@/app/assets/content-img/recent_post2.jpg";
// React-Icons Imports
...
export default function FooterBox() {
  return (
    ...
    >
      <div className="gap-y-40 max-lg:gap-y-14 bg-background-alpha grid grid-cols-(--grid-col-desktop) px-6 pt-20 pb-14 max-md:grid-cols-(--grid-col-mobile) max-lg:place-items-center">
            ...
            <div className="row-span-3 grid grid-rows-subgrid">
              ...
              <div className="flex gap-x-6 mt-12">
                ...
                <div>
                  ...
                  <span className="block text-accent tracking-2pct mt-3 text-base font-medium">
                    April 17, 2018
                  </span>
                </div>
              </div>
            ...
            <div className="row-span-3 grid grid-rows-subgrid">
              ...
              <div className="flex gap-x-6 mt-12">
                ...
                <div>
                  ...
                  <span className="block mt-3 text-accent tracking-2pct text-base font-medium">
                    5 hours ago
                  </span>
                </div>
              </div>
        ...
        <div className="col-start-2 row-start-2 grid grid-cols-[1fr_auto_1fr] place-items-center max-lg:grid-cols-none max-lg:grid-flow-row max-lg:text-center">
          <p className=" tracking-2pct justify-self-start text-lg font-medium max-lg:justify-self-auto max-lg:order-2 max-lg:mt-14 max-lg:max-w-[22ch] max-lg:leading-8">
            Night Club PSD Template <span className="max-lg:hidden">-</span> All Rights Reserved
          </p>
          <div className="grid grid-flow-row gap-y-4 max-lg:order-1">
            <p className="tracking-2pct text-lg font-medium">
              Stay Connected With Us{" "}
            </p>
            <ul className="flex gap-x-6 max-lg:gap-x-0 max-lg:justify-between">
              ...
              <li className="outline-foreground grid aspect-square w-12 place-content-center outline-2 outline-solid">
                <a href="https://snapchat.com" target="_blank">
                  <IoLogoSnapchat className="w-6 h-6"/>
                </a>
              </li>
              <li className="outline-foreground grid aspect-square w-12 place-content-center outline-2 outline-solid">
          ...
          <p className="tracking-2pct justify-self-end text-lg font-medium max-lg:order-3 max-lg:justify-self-auto max-lg:mt-6">
            Copyright © NightClub
          </p>
        </div>
      </div>
